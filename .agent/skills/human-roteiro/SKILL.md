...
description: >-
  ...
  vídeo curto, ou mencionar caption + hashtags + trilha pra Reel.
---

# Human Roteiro — Roteirista de Reels
...
- Use o **browser** (Playwright MCP ou browser integrado) — o IG normalmente
...
para trazer **2 ou 3 ângulos paralelos** — outros recortes, dados, contrapontos
...
Pesquise um **mix de hashtags** relevantes ao tema com busca web — **não invente**. Busque
...
Faça uma busca de **trends musicais do momento** no TikTok/Instagram e sugira
**2-3 trilhas** que combinem com o **ritmo do roteiro**. Diga por que cada uma encaixa.
...
usuário** — é o que impede repetição nas próximas rodadas.
