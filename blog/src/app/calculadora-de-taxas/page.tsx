...
const URL_PATH = "/calculadora-de-taxas";
...
export const metadata: Metadata = {
  title: "Calculadora de Taxas de Plataformas: Quanto Você Perde por Ano? (2026)",
  description:
  ...
  openGraph: {
    title: "Calculadora de Taxas de Plataformas",
    description:
...
export default function CalculadoraPage() {
  const schema = [
    breadcrumbSchema([
      { name: "Início", url: "/" },
      { name: "Calculadora de Taxas de Plataformas", url: URL_PATH },
    ]),
    articleSchema({
      headline: "Calculadora de Taxas de Plataformas",
      description:
  ...
  return (
    <article className="container mx-auto max-w-3xl px-4 py-10">
      ...
      <nav className="mb-6 text-sm text-[#0B132B]/60">
        ...
        / <span>Calculadora de Taxas de Plataformas</span>
      </nav>
